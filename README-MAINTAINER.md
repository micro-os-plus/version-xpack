...
- name the file like `2020-12-19-version-v0-1-0-released.md`
- name the post like: **µOS++ version v7.0.0 released**
...
- `npm dist-tag add @micro-os-plus/version@7.0.0 latest`
- `npm dist-tag ls @@micro-os-plus/version`
...
- paste the release name like **µOS++ version v7.0.0 released**
