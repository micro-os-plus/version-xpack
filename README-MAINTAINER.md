...
```sh
rm -rf ~/Work/micro-os-plus/version-xpack.git && \
mkdir -p ~/Work/micro-os-plus && \
git clone \
  https://github.com/micro-os-plus/version-xpack.git \
  ~/Work/micro-os-plus/version-xpack.git
```
...
Determine the upstream version (like `7.1.2`) and eventually update the
`package.json` file; the format is `7.1.2-pre`.
...
```sh
xpm run install-all -C ~/Work/micro-os-plus/version-xpack.git
xpm run test-all -C ~/Work/micro-os-plus/version-xpack.git
```
