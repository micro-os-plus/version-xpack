...
- name the post like: **µOS++ version v7.0.1 released**
...
- commit all changes
- update `CHANGELOG.md`; commit with a message like _CHANGELOG: prepare v7.0.1_
...
- `npm dist-tag add @micro-os-plus/version@7.0.1 latest`
- `npm dist-tag ls @@micro-os-plus/version`
...
- paste the release name like **µOS++ version v7.0.1 released**
